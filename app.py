        ...
        # --- 1. INITIALIZE GLOBAL NAVIGATION ROUTER ---
        if "page" not in st.session_state:
            st.session_state.page = "home"


        # --- 2. DEFINE PAGE MODULES AS FUNCTIONS ---
        ...
        def show_vegetables_page():
            """Renders the Dehydrated Vegetables catalog sub-page"""
            ...
            st.write("---")
            st.subheader("Our Premium Selection")
            st.write("This section will hold your catalog listings for items like Onion Flakes, Garlic Powder, Ginger Powder, and Carrot Cubes.")


        def show_fruits_page():
            """Renders the Dehydrated Fruits catalog sub-page"""
            if st.button("⬅️ Back to Homepage"):
                st.session_state.page = "home"
                st.rerun()
            ...
            st.write("---")
            st.subheader("Our Premium Selection")
            st.write("This section will hold your catalog listings for items like Strawberry Slices, Mango Chunks, and Dried Apple Slices.")
        ...
        def show_spices_page():
            ...
            st.write("---")
            st.subheader("Our Premium Selection")
            st.write("This section will hold your catalog listings for items like Tamarind Powder, Whole Spices, and custom seasoning mixes.")


        # --- 3. TRAFFIC CONTROL CENTER (EXECUTION) ---
