...
def show_spices_page():
    ...
    with nav_col:
        if st.button(" Home", key="back_spices"):
            ...
            st.rerun()
    with title_col:
        st.markdown("<h2 style='margin:0; padding:0;'> Spices & Powders</h2>", unsafe_allow_html=True)
    st.write("---")
